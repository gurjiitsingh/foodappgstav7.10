...
import com.it10x.foodappgstav7_10.data.online.sync.SyncQueueDao
import com.it10x.foodappgstav7_10.data.online.sync.SyncQueueEntity
import com.it10x.foodappgstav7_10.data.printqueue.PrintQueueEntity
import com.it10x.foodappgstav7_10.data.pos.dao.*
import com.it10x.foodappgstav7_10.data.pos.entities.*
import com.it10x.foodappgstav7_10.data.pos.entities.config.*
...
@Database(
    ...
    version = 98,              // ⬆️ increment version since schema changed
    exportSchema = true
)
